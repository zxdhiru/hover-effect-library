...
const SingleCard = () => {
  ...
  const copyToClipboard = (text:string, setCopiedState:any) => {
  ...
  return (
    <div className="text-white p-8">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 bg-white/90 rounded-lg p-16 shadow-xl">
